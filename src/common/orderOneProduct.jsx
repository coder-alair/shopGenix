    ...
    return (
        <div className="mt-5">
            <div className="container border m-2">
                ...
                {product && (
                    <div className="container m-3" key={product._id}>
                        <div>
            ...
            <div className='mt-5 m-2 container border'>
                ...
                <div className="row"><div className="col-10 mt-1 mb-4">Total Amount </div><div className="col">{deliveryCharges == "Free Delivery" ? totalAmount + " " : totalAmount + " "}</div></div>
            </div>
